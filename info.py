...
API_ID = int(environ.get('API_ID', '4297842'))
API_HASH = environ.get('API_HASH', 'bd495db96a52b1d9381657704e629b95')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002392540102'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1502465002').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001681671211').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sadie:sadie@sadiemol.serz1yo.mongodb.net/?retryWrites=true&w=majority&appName=sadiemol")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://sadie:sadie@sadiemol.serz1yo.mongodb.net/?retryWrites=true&w=majority&appName=sadiemol") # Necessary If clone mode is true
